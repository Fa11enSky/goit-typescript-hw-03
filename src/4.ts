...
abstract class House {
  ...
  comeIn(person: Person): void {
    if (this.door) {
      ...
      console.log("Go");
      // Це для того щоби після того як вхід відбувся двері зачинились бо буде прохідний двір
      this.door = false;
...
class MyHouse extends House {
  ...
  openDoor(key: Key) {
    ...
    } else console.log("Key is not work");
  }
}
const key = new Key();
...
house.comeIn(person);
// Для перевірки іншого ключа іншої особи
